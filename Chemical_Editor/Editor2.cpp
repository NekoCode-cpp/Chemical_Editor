...
Editor2::Editor2(const InitData& init)
	: IScene{ init }
{
...
void Editor2::add_chemical_view() {
...
Array<ChemicalButton> Editor2::generate_chemicals_symbol_btn(Array<Chemical> chemicals) const {
...
Array<Chemical> Editor2::load_chemicals(void) const {
